        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
          <div>
            ...
            <p className='text-gray-600 mb-4'>
              Founded in 2020, BrainWave started as a small project by a group
              of passionate educators who saw a gap in the online learning
              market. We wanted to create a platform that was not just a
              repository of video lectures, but a vibrant community for learners
              and instructors.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 mt-2'>
              The passionate people behind BrainWave.
            </p>
          </div>
